...
- DOI/链接：[10.1117/12.3116253](https://doi.org/10.1117/12.3116253)
- 期刊/年份：Third International Conference on Optoelectronic Information and Optical Engineering (OIOE 2026)，2026
- 摘要日期：`2026-08-08`
- 候选 ID：`7d6c2a059923ebe445a1cdf7`
- 标签：application:加速人工智能计算, application:大型模型部署, architecture:unclear, hardware_validation:unclear, project:optical-neural-networks

### Partially coherent high-order optical neural networks via pseudo-nonlinear encoding

- DOI/链接：[10.21203/rs.3.rs-10187577/v1](https://doi.org/10.21203/rs.3.rs-10187577/v1)
- 期刊/年份：Research Square，2026
- 摘要日期：`2026-08-08`
- 候选 ID：`1e35265ce8678ca96adb8b93`
- 标签：application:图像分类（digit mnist、fashion mnist、raf面部表情、medmnist医学图像）, architecture:unclear, hardware_validation:mixed, project:optical-neural-networks

### Integrated diffractive optical neural network with electroabsorption modulators

- DOI/链接：[10.1364/cleo_at.2026.jtu.84](https://doi.org/10.1364/cleo_at.2026.jtu.84)
- 期刊/年份：CLEO 2026，2026
- 摘要日期：`2026-08-08`
- 候选 ID：`5017adbd33e6ddd5c320a4c4`
- 标签：application:未提供, architecture:free_space, hardware_validation:physical_experiment, project:optical-neural-networks

### Enhancing the robustness of optical neural networks via joint Mach–Zehnder interferometer phase optimization

- DOI/链接：[10.1117/1.oe.65.7.073102](https://doi.org/10.1117/1.oe.65.7.073102)
- 期刊/年份：Optical Engineering，2026
- 摘要日期：`2026-08-07`
- 候选 ID：`541094f286db8902f2fe6077`
- 标签：application:图像分类（mnist、fashion-mnist）, architecture:unclear, hardware_validation:simulation_only, project:optical-neural-networks

### Distillation-guided optical neural networks with reinforcement learning-assisted calibration

- DOI/链接：[10.1364/optica.591264](https://doi.org/10.1364/optica.591264)
- 期刊/年份：Optica，2026
- 摘要日期：`2026-08-07`
...
- DOI/链接：[10.48550/arxiv.2609.07666](https://doi.org/10.48550/arxiv.2609.07666)
- 期刊/年份：arXiv (Cornell University)，2026
- 摘要日期：`2026-09-11`
- 候选 ID：`3c46ab2b3d315aef47db028e`
- 标签：project:zeroth-order-optimization, zo:forward_only, zo:low_rank_or_subspace, zo:query_reuse, zo:structured_perturbation
...
- DOI/链接：[10.48550/arxiv.2608.03277](https://doi.org/10.48550/arxiv.2608.03277)
- 期刊/年份：arXiv (Cornell University)，2026
- 摘要日期：`2026-08-07`
- 候选 ID：`142dc76f41fc25448b82c91e`
- 标签：project:zeroth-order-optimization, zo:forward_only, zo:low_rank_or_subspace, zo:query_reuse, zo:structured_perturbation
